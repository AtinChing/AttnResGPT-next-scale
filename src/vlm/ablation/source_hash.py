...
CANONICAL_SOURCE_RELPATHS: tuple[str, ...] = (
    ...
    "src/vlm/clevr/__init__.py",
    "src/vlm/clevr/official.py",
    "src/vlm/clevr/download.py",
    "src/vlm/clevr/prepare.py",
    "src/vlm/clevr/dataset.py",
    "src/vlm/clevr/tokenizer.py",
    "src/vlm/clevr/preprocess.py",
    "src/vlm/clevr/subsets.py",
    "src/vlm/clevr/programs.py",
    "src/vlm/clevr/validate.py",
    "src/vlm/clevr/extract.py",
